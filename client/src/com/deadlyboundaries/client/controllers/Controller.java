...
public class Controller {
    ...
    public void playerLeftClicked(float destX, float destY) {
        ...
        log.debug("Before changes, game state is: " + MyGame.controller.getLocalState());
        ...
        MyGame.client.sendTCP(moveActionDto);
        log.debug("After changes, game state is: " + MyGame.controller.getLocalState());
    }
    ...
    public void playerRightClicked(float screenX, float screenY) {
        ...
        if (player instanceof RangedPlayer rp) {
            ...
            MyGame.client.sendTCP(playerAttackDto);
        }
    }
